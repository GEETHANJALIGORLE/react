        ...
        return(
                ...
                <div class="wrapper">
                    <div class="sidebar col-12">
                        <div class="head">
                            <img src="logo.png" alt="" class="col-3" style={{width: "60px",height: "60px"}}/><p id="firebase" class="col-2 d-flex align-content-center" style={{color: "white", textAlign: "center"}}> Firebase</p>
                        </div>
